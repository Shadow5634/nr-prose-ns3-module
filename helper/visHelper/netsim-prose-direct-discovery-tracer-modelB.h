...
#ifndef NETSIM_PROSE_DIRECT_DISCOVERY_TRACER_MB_H
#define NETSIM_PROSE_DIRECT_DISCOVERY_TRACER_MB_H
...
/*
 * NetSimulyzer helper for charting related to U2U direct discovery model B
 ...
 *
 * TODO: Charting features
 * - A histogram of #distinct ues discovered by each node
 */
class NetSimulyzerProseDirectDiscoveryTracerModelB
{
public:
  NetSimulyzerProseDirectDiscoveryTracerModelB();
...
#endif /* NETSIM_DIRECT_DISCOVERY_TRACER_MB_H */
